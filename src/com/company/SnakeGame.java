...
public class SnakeGame {
    ...
    public static int xPixelMaxDimension = 1201;  //Pixels in window. 501 to have 50-pixel squares plus 1 to draw a border on last square
    ...
    protected static GameClock clockTick;//////sdsdds
    ...
    protected static void newGame() {
        //get highscore
        score.getStringHighScore();
        timer = new Timer();
         clockTick = new GameClock(snake, kibble, score, snakePanel);
       // if (ev.getKeyCode()== KeyEvent.VK_W){try{SnakeGame.timer.purge();SnakeGame.setClockInterval(getGameStage()+(SnakeGame.getClockInterval()/2));}catch(Exception e){System.out.print(e);}}

        timer.scheduleAtFixedRate(clockTick, 0 , getClockInterval());
