...
public class Snake {
    ...
    public Snake(int maxX, int maxY, int squareSize) {
        this.maxX = (int)(SnakeGame.xPixelMaxDimension/ SnakeGame.squareSize);
        this.maxY = (int)(SnakeGame.yPixelMaxDimension/ SnakeGame.squareSize);
...
//	}
    ...
    protected void moveSnake() {
        ...
        //worp snake
        if (GameControls.isWall) {
            if (snakeHeadX >= (int)(SnakeGame.xPixelMaxDimension/ SnakeGame.squareSize) ){
                snakeHeadX = 0;
            }
            if (snakeHeadX < (0)) {
                snakeHeadX = (int)(SnakeGame.xPixelMaxDimension/ SnakeGame.squareSize) - 1;
                System.out.print( SnakeGame.xPixelMaxDimension );
            }
            if (snakeHeadY >= maxY) {
                snakeHeadY = 0;
            }
        ...
        if (GameControls.isbulidWall) {System.out.print(snakeHeadX);
            if  (snakeHeadX < 1 || snakeHeadX == maxX-1 || snakeHeadY <1 || snakeHeadY == maxY-1){
                hitWall = true;
            SnakeGame.setGameStage(SnakeGame.GAME_OVER);
            return;
        }
